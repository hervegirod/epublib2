...
import nl.siegmann.epublib.util.io.XmlStreamReader;
...
public class Resource implements Serializable {
   ...
   public void setData(String data) throws IOException {
      ...
      this.data = IOUtil.toByteArray(in, Constants.CHARACTER_ENCODING);
   }
   ...
   public String toString() {
      return StringUtil.toString("id", id, "title", title, "encoding", inputEncoding,
         "mediaType", mediaType, "href", href, "size", (data == null ? 0 : data.length));
   }
}
